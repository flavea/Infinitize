...
class CreateAwardsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Awards", 'awards', 'name', 'fa-trophy', [
            ["name", "Name", "TextField", false, "", 0, 256, true],
            ["received", "Received Date", "Date", false, "", 0, 0, true],
            ["type", "Music Show Win?", "Checkbox", false, "", 0, 0, true],
            ["for", "For", "Dropdown", false, "0", 0, 0, false, "@songs"],
        ]);
