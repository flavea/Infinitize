...
class CreateDramasTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Dramas", 'dramas', 'title', 'fa-file-movie-o', [
            ["title", "Title", "TextField", false, "", 0, 256, true],
            ["type", "Type", "Dropdown", false, "", 0, 0, true, "@drama_types"],
            ["description", "Description", "Textarea", false, "", 0, 0, false],
            ["released", "Date Released", "Date", false, "", 0, 0, true],
            ["poster", "Poster", "URL", false, "", 0, 256, false],
