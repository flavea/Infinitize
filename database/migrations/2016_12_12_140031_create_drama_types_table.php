...
class CreateDramaTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Drama_types", 'drama_types', 'name', 'fa-file-movie-o', [
    ...
    {
        if (Schema::hasTable('drama_types')) {
            Schema::drop('drama_types');
        }
    }
}
