...
class CreateCompositionsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Compositions", 'compositions', 'song', 'fa-pencil', [
            ["song", "Song (If IFNT Song)", "Dropdown", false, "", 0, 0, false, "@songs"],
            ["altsong", "Alt Song", "TextField", false, "", 0, 256, false],
            ["members", "Members", "Multiselect", false, "", 0, 0, true, "@members"],
